...
pi_true = min_var_portfolio(Sigma, gamma=None)
...
stat = pd.DataFrame(np.zeros((5,3)),
                    index   = ['forecast_var_ratio','is_var','oos_var','te','true_var_ratio'],
                    columns = ['New estimator','Old estimator','Sample estimator'])

stat['New estimator'] = [var_new['forecast_var_ratio'],var_new['is_var'],var_new['oos_var'],var_new['te'],var_new['true_var_ratio']]
stat['Old estimator'] = [var_old['forecast_var_ratio'],var_old['is_var'],var_old['oos_var'],var_old['te'],var_old['true_var_ratio']]
stat['Sample estimator'] = [var_sample['forecast_var_ratio'],var_sample['is_var'],var_sample['oos_var'],var_sample['te'],var_sample['true_var_ratio']]
